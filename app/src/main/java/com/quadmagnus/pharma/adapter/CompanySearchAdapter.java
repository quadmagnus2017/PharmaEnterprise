...
public class CompanySearchAdapter extends BaseAdapter {
    ...
    public CompanySearchAdapter(Context mContext, List<CompanySearchModel> mListClassic) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_item_search_company, null);
            // Locate the TextViews in listview_item.xml
            holder.txtTitle = (TextView) convertView.findViewById(R.id.txt_search_company);
